...
ValidationData = pd.read_parquet('../data_tro/SingleRobotProcessed/ValidationData4.parquet').to_numpy().astype('float32')
...
# Load Test Data
TestData = pd.read_parquet('../data_tro/SingleRobotProcessed/TestingDataCollision4.parquet').to_numpy().astype('float32')
...
# Load Test Free Data
TestDataFree = pd.read_parquet('../data_tro/SingleRobotProcessed/TestingDataFree4.parquet').to_numpy().astype('float32')
